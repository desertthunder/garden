...
- [x] Collapsible explorer state only after the static tree works.
...
- [x] Add backlinks by scanning internal links and showing "Linked from" on note pages.
- [x] Store backlink data once at build time.
- [x] Show backlink title and short excerpt.
- [x] Hide backlinks when a note has none.
- [x] Add backlink cards inspired (footer context).
- [x] Show linked-from notes as compact cards with title and excerpt.
...
- [x] Show related notes below the article or in the right rail.
- [ ] Exclude current, hidden, draft, and previous/next notes from related notes.
- [x] Add hover previews for internal links, using prebuilt excerpts instead of fetching whole pages.
- [x] Generate preview payloads at build time.
- [x] Keep hover previews text-first in the first pass.
- [x] Disable or simplify hover previews on touch/mobile.
...
- [x] Reuse note metadata across pages, listings, previews, and related-note cards.
...
- [x] Put table of contents, backlinks, related notes, latest notes, and same-folder notes in the right rail.
...
- [x] Add a JSON content index that powers graph, backlinks, related notes, and future interactive features.
- [ ] Keep Pagefind as the full-text search index.
- [x] Keep the JSON content index separate from Pagefind.
- [x] Store path, title, excerpt, tags, status, dates, folder, outbound links, and backlinks in the JSON content index.
- [x] Generate the JSON content index from the same content scan used for backlinks and related notes.
